...
const char* filename = "D:/WordChain/wordlist.txt";  // Word List File Path
...
int main()
{
	...
	//cout << "Loading word list. This will take around 10 minutes as text file has 60000 words ..." << endl;
	vector<string> words;
	string w;
